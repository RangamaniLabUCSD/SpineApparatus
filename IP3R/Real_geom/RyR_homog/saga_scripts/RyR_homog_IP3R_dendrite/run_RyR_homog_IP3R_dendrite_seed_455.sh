#!/bin/bash
# Job name:
#SBATCH --job-name=Real_geom_homog_455
...
srun python3.9 /home/mariahernandez/D1/Spines/ActiveSA/IP3R/Real_geom/RyR_homog/IP3R_dendrite_files/mcell/output_data/model.py -seed 455 
